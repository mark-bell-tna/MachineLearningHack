...
- Can randomly split the data as on previous slide
- Training data is expensive so we limit the size of the validation set
- The validation set may not be fully representative
- We may also overfit against the training set
